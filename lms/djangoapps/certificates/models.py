...
def handle_post_cert_generated(sender, user, course_key, mode, status, **kwargs):  # pylint: disable=unused-argument
    """
...
def create_badge(sender, user, course_key, mode, status, **kwargs):
    """
